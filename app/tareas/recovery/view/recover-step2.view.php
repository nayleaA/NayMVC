                ...
                <div class="card-body text-center">
                    ...
                    <form action="" method="post">
                            <div class="form-floating mb-3">
                                ...
                                <label class="form-label" for="password" style="text-decoration: underline red; color: black;">Establezca la nueva Contraseña* </label>
                            </div>

                        <button class="btn btn-outline-primary" type="submit"><?php echo isset( $user_name ) ? "Cambiar contraseña" : "Enviar"; ?></button>
                    </form>
